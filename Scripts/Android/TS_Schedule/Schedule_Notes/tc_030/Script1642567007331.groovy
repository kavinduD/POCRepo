...
CustomKeywords.'com.ifs.fsm.android.LIB_Schedule.bf_Notes_AddNote'(GlobalVariable.var_Schedule_Notes_TextLineCode, GlobalVariable.var_Schedule_Notes_TextBlock, 
    'Test text')
