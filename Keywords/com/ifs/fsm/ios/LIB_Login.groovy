...
class LIB_Login {
	...
	public void bf_Login(String application, String username, String password) {
		...
		//Mobile.startApplication('kobiton-store:297241', true)
		...
		//Mobile.tap(findTestObject('iOS/PG_Login/XCUIElementTypeImage - IFS_logo_new.png'), 0)
		Mobile.tapAndHold(findTestObject('iOS/PG_Login/btn_Login'), 0, 0)
		Thread.sleep(3000)
	}

	/**
	 * Click on Hamburger icon on Top right and click Close App
	 */
	@Keyword
